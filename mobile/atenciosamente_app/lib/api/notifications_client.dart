...
// Base URL of the backend. For a real device on the same LAN, use the WSL2
// host's LAN IP. Android emulator would use http://10.0.2.2:8080 instead.
const String _baseUrl = 'http://172.22.238.44:8080';

// Future<T> is Dart's equivalent of std::future<T> — a value that isn't ready
...
Future<List<AppNotification>> fetchNotifications() async {
  ...
  if (response.statusCode != 200) {
    // Throwing here surfaces the error to whoever awaits fetchAppNotifications().
